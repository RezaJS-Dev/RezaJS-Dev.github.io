...
// Initialize the Resend client with your API key const resend = new Resend(process.env.RESEND_API_KEY);
...
export async function sendEmail({to, subject, html}) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: "REZA.JS Portfolio <onboarding@resend.dev>",  // Replace with your verified sender domain
